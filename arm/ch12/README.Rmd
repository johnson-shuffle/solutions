...
The unmodeled (or to be misleading "fixed") coefficients, $\beta$, $\gamma_0$, and $\gamma_1$, are similar.  The individual- and group-level standard deviations are smaller in the one fifth sample.  A graph is more suitable for comparision of the county-level intercepts:
