...
#### (b)
The above model has coefficients consistent with expecation: weathly white Republican respondents are more likely to support Bush.  Conversely, more educated and respondents are more likely to support to Clinton.
...
Import the data:
```{r arm05-q08, warning = F, message = F}
dat <- read_delim(
